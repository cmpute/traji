...
class PathPosition:
    ...
    @classmethod
    def from_s(cls, path: Union[Path, Trajectory], s: float) -> PathPosition: ...
    def to_s(self, path: Union[Path, Trajectory]) -> float: ...
    @classmethod
    def from_t(cls, traj: Trajectory, t: float) -> PathPosition: ...
...
class Trajectory(Path):
    ...
    def velocity_from(self, s: float) -> Tuple[float, float]: ...
    def velocity_at(self, pos: Union[float, PathPosition]) -> Tuple[float, float]: ...
